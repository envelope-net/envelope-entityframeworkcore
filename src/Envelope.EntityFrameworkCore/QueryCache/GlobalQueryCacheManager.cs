...
namespace Envelope.EntityFrameworkCore.QueryCache;
...
public static class GlobalQueryCacheManager
{
	...
	static GlobalQueryCacheManager()
	{
		...
		CachePrefix = "Envelope.EntityFrameworkCore.QueryCache.GlobalQueryCacheManager;";
		CacheTypePostfix = "_Envelope_GlobalQueryCacheManager_CacheType";
